...
5. **Spoilt/worn-out item routing** — items marked worn-out are nudged toward external donation organizations, thrift shops, or repurposing, via a pre-formed secondhand marketplace search link built from the item's category/color/tags. Following through on donating, selling, or repurposing awards XP, same as a completed challenge.
6. **XP, streaks & leaderboard** — the core habit engine. XP is earned specifically through *smart choices*: confirming the daily outfit was worn, skipping a purchase or buying secondhand in Buy Check, completing a wardrobe challenge, and donating/selling/repurposing an item. XP feeds into a streak counter and a leaderboard, giving the app a social, competitive layer.
