...
export default function SavedFitsScreen({ onNavigate, fits, onOpenFit, onRemoveFit }: Props) {
  return (
    <div className="bg-[#f7f5f2] min-h-screen pb-10">
      ...
      <div className="px-5">
        ...
        {fits.length === 0 ? (
          ...
          <div key={f.id} className="w-full bg-white border border-[#edebe6] rounded-[22px] p-3 mb-3 text-left">
