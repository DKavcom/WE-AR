...
interface Props extends NavProps { items: ClothingItem[]; onSustainableAction: (itemId: string, action: SustainableAction) => void }

export default function WardrobeScreen({ onNavigate, items, onSustainableAction }: Props) {
